...
Expresion=Asigna(Info.ID,Gasto:Gasto.ID)    <BR>ReportePantalla(ReporteMovPantalla(<T>GAS<T>, Gasto:Gasto.Mov, Gasto:Gasto.Estatus), Gasto:Gasto.ID)
...
Expresion=Asigna(Info.ID,Gasto:Gasto.ID)          <BR>ReporteImpresora(ReporteMovImpresora(<T>GAS<T>, Gasto:Gasto.Mov, Gasto:Gasto.Estatus), Gasto:Gasto.ID)
...
Boton=0
NombreDesplegar=Ver Política Co&ncepto
EnMenu=S
TipoAccion=Formas
...
AntesExpresiones=Asigna(Info.PuedeEditar, Gasto:Gasto.Estatus en (EstatusSinAfectar, EstatusBorrador, EstatusPorConfirmar))<BR>Asigna(Info.Modulo, <T>GAS<T>)<BR>Asigna(Info.ID, Gasto:Gasto.ID)<BR>Asigna(Info.Mov, Gasto:Gasto.Mov)<BR>Asigna(Info.MovID, Gasto:Gasto.MovID)<BR>Asigna(Info.Ejercicio, Año(Gasto:Gasto.FechaEmision))<BR>Asigna(Info.ClavePresupuestal, GastoD:GastoD.ClavePresupuestal)<BR>Asigna(Info.Tipo, Si(Gasto:MovTipo.ReservarCP=<T>Desreservar<T>, <T>Reduccion<T>,<T>Ampliacion<T>))<BR>Asigna(Info.Importe, Suma(GastoD:Total)+Suma(GastoD:RetencionTotal))
...
[Detalle.GastoD.CodigoPartida]
Carpeta=Detalle
Clave=GastoD.CodigoPartida
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Detalle.GastoD.SVProyecto]
Carpeta=Detalle
Clave=GastoD.SVProyecto
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Detalle.GastoD.SVProyectoNombre]
Carpeta=Detalle
Clave=GastoD.SVProyectoNombre
LineaNueva=S
ValidaNombre=S
3D=S
Tamano=200
...
[Detalle.GastoD.SVFaseNombre]
Carpeta=Detalle
Clave=GastoD.SVFaseNombre
LineaNueva=S
ValidaNombre=S
3D=S
Tamano=200
...
[Detalle.GastoD.SVEtapa]
Carpeta=Detalle
Clave=GastoD.SVEtapa
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Detalle.GastoD.SVEtapaNombre]
Carpeta=Detalle
Clave=GastoD.SVEtapaNombre
LineaNueva=S
ValidaNombre=S
3D=S
Tamano=200
...
[Detalle.GastoD.LibroIVA]
Carpeta=Detalle
Clave=GastoD.LibroIVA
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
EditarConBloqueo=S
[Detalle.GastoD.ExentoSV]
Carpeta=Detalle
Clave=GastoD.ExentoSV
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Detalle.GastoD.TipoImporteSV]
Carpeta=Detalle
Clave=GastoD.TipoImporteSV
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Detalle.GastoD.SVEtapaAC]
Carpeta=Detalle
Clave=GastoD.SVEtapaAC
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Detalle.GastoD.svsubetapa]
Carpeta=Detalle
Clave=GastoD.svsubetapa
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Detalle.GastoD.DescripcionExtra]
Carpeta=Detalle
...
[Ficha.Gasto.SVRetenciones]
Carpeta=Ficha
Clave=Gasto.SVRetenciones
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
[Ficha.Gasto.SVRetOtras]
Carpeta=Ficha
Clave=Gasto.SVRetOtras
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Ficha.Gasto.SVRetIva]
Carpeta=Ficha
Clave=Gasto.SVRetIva
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Ficha.Gasto.SVTipoDocumento]
Carpeta=Ficha
Clave=Gasto.SVTipoDocumento
Editar=S
ValidaNombre=S
3D=S
Tamano=20
...
Gasto.AF=Gasto.Saldo
Gasto.Saldo=Gasto.ConVigencia
Gasto.ConVigencia=Gasto.SVRetenciones
Gasto.SVRetenciones=Gasto.SVTipoDocumento
Gasto.SVTipoDocumento=Gasto.SVRetOtras
Gasto.SVRetOtras=Gasto.SVRetIva
Gasto.SVRetIva=(Fin)
...
[Detalle.GastoD.SvTipoDocCajaC]
Carpeta=Detalle
Clave=GastoD.SvTipoDocCajaC
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
GastoD.Fecha=GastoD.SvTipoDocCajaC
GastoD.SvTipoDocCajaC=GastoD.Referencia
GastoD.Referencia=GastoD.DescripcionExtra
GastoD.DescripcionExtra=GastoD.Cantidad
...
GastoD.SecuenciaRetencion=GastoD.SVProyecto
GastoD.SVProyecto=GastoD.SVProyectoNombre
GastoD.SVProyectoNombre=GastoD.SVFase
GastoD.SVFase=GastoD.SVFaseNombre
GastoD.SVFaseNombre=GastoD.SVEtapa
GastoD.SVEtapa=GastoD.SVEtapaNombre
GastoD.SVEtapaNombre=GastoD.SVEtapaAC
GastoD.SVEtapaAC=GastoD.svsubetapa
GastoD.svsubetapa=GastoD.LibroIVA
GastoD.LibroIVA=GastoD.CodigoPartida
GastoD.CodigoPartida=SVProyectoPPTOD.PartidaDetalle
SVProyectoPPTOD.PartidaDetalle=GastoD.ExentoSV
GastoD.ExentoSV=GastoD.TipoImporteSV
GastoD.TipoImporteSV=(Fin)

[Detalle.ListaCamposAValidar]
(Inicio)=Personal.Nombre
Personal.Nombre=Acreedor.Nombre
Acreedor.Nombre=Personal.ApellidoPaterno
