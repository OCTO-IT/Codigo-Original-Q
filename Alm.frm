...
Antes=S
AntesExpresiones=Si (Alm:Alm.Tipo=<T>Estructura<T>) y (Alm:Alm.Rama=<T><T>)<BR>Entonces<BR>  Asigna(Alm:Alm.Rama,Nulo)     <BR>Fin
[Acciones.Cerrar]
Nombre=Cerrar
Boton=0
Menu=&Archivo
...
[WMS.DescripcionRecibo]
Carpeta=WMS
Clave=DescripcionRecibo
Editar=S
ValidaNombre=N
3D=S
Tamano=45
...
[WMS.DescripcionSurtido]
Carpeta=WMS
Clave=DescripcionSurtido
Editar=S
LineaNueva=N
ValidaNombre=N
3D=S
...
[Ubicaciones.DescripcionSurtido]
Carpeta=Ubicaciones
Clave=DescripcionSurtido
LineaNueva=N
ValidaNombre=N
...
Alm.DefPosicionRecibo=DescripcionRecibo
DescripcionRecibo=Alm.DefPosicionSurtido
Alm.DefPosicionSurtido=DescripcionSurtido
DescripcionSurtido=(Fin)
