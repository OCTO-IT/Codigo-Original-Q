...
Expresion=RegistrarSeleccionIDRenglon( <T>Lista<T>, <T>CompraConfirmarD.Modulo<T>, <T>CompraConfirmarD.ID<T>, <T>CompraConfirmarD.Renglon<T>, <T>CompraConfirmarD.RenglonSub<T>)<BR>ProcesarSQL(<T>spCompraCotizacionAutorizar :nEstacion, :tEmpresa, :nSucursal, :tUsuario, :fFecha, :tMov<T>,  EstacionTrabajo, Empresa, Sucursal, Usuario, FechaTrabajo, Info.MovGenerar)
