...
FiltroRespetar=S
FiltroTipo=General
FiltroGeneral=SVProyectoPPTOEtapa.CodigoPartida=<T>{Info.SVCodigoPartida}<T>
...
[SVProyectoPPTOEtapa.SVProyectoPPTOEtapa.Distribucion]
Carpeta=SVProyectoPPTOEtapa
...
CarpetaVisible=S
Totalizadores2=SUMA(SVProyectoPPTOEtapa:SVProyectoPPTOEtapa.Presupuesto)<BR>SUMA(SVProyectoPPTOEtapa:SVProyectoPPTOEtapa.Distribucion)<BR>SUMA(Info.SVPresupuesto)
...
(Inicio)=SVProyectoPPTOEtapa.Etapa
SVProyectoPPTOEtapa.Etapa=SVProyectoEtapa.Descripcion
SVProyectoEtapa.Descripcion=SVProyectoPPTOEtapa.Distribucion
