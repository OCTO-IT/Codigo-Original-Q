[Forma]
Clave=RepNominaRecibo
Nombre=<T>Recibos de Nómina<T>
Icono=0
Modulos=(Todos)
...
EnBarraHerramientas=S
EspacioPrevio=S
ListaAccionesMultiples=Variables Asignar<BR>NominaRecibo
Activo=S
Visible=S
...
[Acciones.Preliminar.NominaRecibo]
Nombre=NominaRecibo
Boton=0
...
[Acciones.Imprimir.NominaRecibo]
Nombre=NominaRecibo
Boton=0
