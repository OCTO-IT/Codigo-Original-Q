...
Expresion=Si<BR> Gestion:Gestion.Estatus en (EstatusPendiente, EstatusAltaPrioridad, EstatusPrioridadBaja)<BR>Entonces<BR>  Asigna(Info.Modulo, <T>GES<T>)<BR>  Asigna(Info.Mov, Gestion:Gestion.Mov)<BR>  Asigna(Info.MovID, Gestion:Gestion.MovID)<BR>  Si(Forma(<T>GenerarMovFlujo<T>), Generar(<T>GES<T>, Gestion:Gestion.ID, Gestion:Gestion.Mov, Gestion:Gestion.MovID, <T>Todo<T>, Info.MovGenerar, <T>Gestion<T>))<BR>Sino<BR>  Si<BR>    Gestion:Gestion.Estatus=EstatusSinAfectar<BR>  Entonces<BR>    Afectar(<T>GES<T>, Gestion:Gestion.ID, Gestion:Gestion.Mov, Gestion:Gestion.MovID, <T>Todo<T>, <T><T>, <T>Gestion<T>)<BR>  Fin<BR>Fin
