...
[Nomina.EmpresaCfg.NomISRSimplificado]
Carpeta=Nomina
Clave=EmpresaCfg.NomISRSimplificado
Editar=S
3D=S
Tamano=20
ColorFondo=Blanco
...
[Nomina.EmpresaCfg.NomPremios]
Carpeta=Nomina
Clave=EmpresaCfg.NomPremios
Editar=S
LineaNueva=S
3D=S
Tamano=30
...
[Nomina.EmpresaCfg.NomPorcentajeSubsidio]
Carpeta=Nomina
Clave=EmpresaCfg.NomPorcentajeSubsidio
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Nomina.EmpresaCfg.NomComplemento]
Carpeta=Nomina
Clave=EmpresaCfg.NomComplemento
Editar=S
LineaNueva=S
3D=S
Tamano=20
...
[Nomina.EmpresaCfg.NomComplementoTope]
Carpeta=Nomina
Clave=EmpresaCfg.NomComplementoTope
Editar=S
LineaNueva=N
3D=S
Tamano=20
...
[Nomina.EmpresaCfg.NomComplementoRetencion]
Carpeta=Nomina
Clave=EmpresaCfg.NomComplementoRetencion
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
[Nomina.EmpresaCfg.NomComplementoPremios]
Carpeta=Nomina
Clave=EmpresaCfg.NomComplementoPremios
Editar=S
ValidaNombre=S
3D=S
Tamano=20
...
(Inicio)=EmpresaCfg.NomPorcentajeSubsidio
EmpresaCfg.NomPorcentajeSubsidio=EmpresaCfg.NomOmision
...
EmpresaCfg.NomConceptoSDI=EmpresaCfg.NomISRSimplificado
EmpresaCfg.NomISRSimplificado=EmpresaCfg.NomModificarFechaNomina
EmpresaCfg.NomModificarFechaNomina=EmpresaCfg.NomValidarReferencias
EmpresaCfg.NomValidarReferencias=EmpresaCfg.NomPremios
EmpresaCfg.NomPremios=EmpresaCfg.NomComplemento
EmpresaCfg.NomComplemento=EmpresaCfg.NomComplementoTope
EmpresaCfg.NomComplementoTope=EmpresaCfg.NomComplementoPremios
EmpresaCfg.NomComplementoPremios=EmpresaCfg.NomComplementoRetencion
EmpresaCfg.NomComplementoRetencion=(Fin)
...
EmpresaCfg2.GastoRetencion3Concepto=(Fin)
...
EmpresaCfg.ProyGenerarInvTiempoUnidad=(Fin)
...
[RH.EmpresaCfg.RHIDSE]
Carpeta=RH
Clave=EmpresaCfg.RHIDSE
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[RH.EmpresaCfg.RHIDSERuta]
Carpeta=RH
Clave=EmpresaCfg.RHIDSERuta
Editar=S
ValidaNombre=S
3D=S
Tamano=30
...
EmpresaCfg2.OfertaNivelOpcion=(Fin)
...
EmpresaCfg.CompraAutoEndosoMovs=(Fin)
...
EmpresaCfg.NomCCRequerido=EmpresaCfg.RHIDSE
EmpresaCfg.RHIDSE=EmpresaCfg.RHIDSERuta
EmpresaCfg.RHIDSERuta=(Fin)
...
EmpresaCfg2.VentaMonedero=EmpresaCfg2.VentaPuntosEnVales
...
EmpresaCfg.AsisteGenerarHorasExtras=EmpresaCfg.AsisteJornadasNocturnas
...
EmpresaCfg.WMSTipoAcomodador=EmpresaCfg.WMSPermitirReacomodosDomicilio
EmpresaCfg.WMSPermitirReacomodosDomicilio=EmpresaCfg.WMSValidarZona
EmpresaCfg.WMSValidarZona=EmpresaCfg.WMSReacomodoSurtido
EmpresaCfg.WMSReacomodoSurtido=(Fin)
