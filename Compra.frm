...
EjecucionMensaje=Si(Vacio(Compra:Compra.ID), <T>Es Necesario Guardar el Movimiento Antes de Ejecutar esta Opción<T>, <T>Falta Indicar el Artículo<T>)
...
Activo=S
ConCondicion=S
EjecucionCondicion=Compra:Compra.Mov<><T>Trancito<T>
EjecucionMensaje=<T>no se puede copiar el movimiento de Trancito<T>
EjecucionConError=S
...
Pestana=S
PestanaOtroNombre=S
PestanaNombre=Datos de Importación
...
Boton=0
Menu=&Edición
NombreDesplegar=Generar &Extracción
EnMenu=S
TipoAccion=Formas
...
Nombre=EmidaDetalle
Boton=0
NombreDesplegar=Emida - Detalle Recargas Telefónicas
EnMenu=S
EspacioPrevio=S
TipoAccion=Formas
