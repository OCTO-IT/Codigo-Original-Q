...
AntesExpresiones=Asigna(Info.CodigoPostal, CodigoPostal:CodigoPostal.CodigoPostal)<BR>Asigna(Info.Colonia, CodigoPostal:CodigoPostal.Colonia)<BR>Asigna(Info.Delegacion, CodigoPostal:CodigoPostal.Delegacion)<BR>Asigna(Info.Estado, CodigoPostal:CodigoPostal.Estado)<BR>Asigna(Info.Pais, <T>Mexico<T>)<BR>Asigna(Info.Ruta, CodigoPostal:CodigoPostal.Ruta)<BR>Asigna(Afectar.ID, CodigoPostal:CodigoPostal.ID)
