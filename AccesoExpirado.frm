...
AntesExpresiones=Si<BR>  ContrasenaCorrecta(Usuario:Usuario.Contrasena, Usuario:Usuario.ContrasenaConfirmacion)<BR>Entonces<BR>  Asigna(Usuario:Usuario.Contrasena, MD5(Usuario:Usuario.Contrasena, <T>p<T>))<BR>  Asigna(Usuario:Usuario.ContrasenaConfirmacion, MD5(Usuario:Usuario.ContrasenaConfirmacion, <T>p<T>))<BR>  Asigna(Usuario:Usuario.ContrasenaModificar, Falso)<BR>Sino<BR>  Error(<T>Contraseña Incorrecta<T>)<BR>  AbortarOperacion<BR>Fin
