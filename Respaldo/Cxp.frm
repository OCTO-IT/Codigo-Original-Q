...
Expresion=Asigna(Info.ID,Cxp:Cxp.ID)  <BR>ReportePantalla(ReporteMovPantalla(<T>CXP<T>, Cxp:Cxp.Mov, Cxp:Cxp.Estatus), Cxp:Cxp.ID)
...
Expresion=Asigna(Info.ID,Cxp:Cxp.ID)  <BR>ReporteImpresora(ReporteMovImpresora(<T>CXP<T>, Cxp:Cxp.Mov, Cxp:Cxp.Estatus), Cxp:Cxp.ID)
