...
Cxc.TarjetaBancariaAutorizacion=Cxc.Articulo
Cxc.Articulo=Art.Descripcion1
Art.Descripcion1=Cxc.Observaciones
...
[Acciones.svInteresesCxC]
Nombre=svInteresesCxC
Boton=61
NombreEnBoton=S
NombreDesplegar=Tabla de Intereses
EnBarraHerramientas=S
EnMenu=S
TipoAccion=Formas
ClaveAccion=svInteresesCxC
Activo=S
Visible=S
...
Expresion=EjecutarSQL(<T>svInsertarIntereses :n1,:t1,:t2<T>,Cxc:Cxc.ID,Cxc:Cxc.Usuario,Cxc:Cxc.Empresa)
...
Otros8=Otros9
Otros9=LDIMovLog
LDIMovLog=svInteresesCxC
svInteresesCxC=Generar
Generar=(Fin)
