...
ListaCarpetas=(Lista)
CarpetaPrincipal=PropiedadesAF
...
EnMenu=S
TipoAccion=Expresion
Expresion=Asigna(Info.Tabla, <T>ActivoF<T>)<BR>Asigna(Info.Llave, Carpeta.LlavePrimaria(<T>Ficha<T>, <T>|<T>))<BR>Si(Version.RegHist y (SQL(<T>SELECT Estatus FROM CfgRegHist WHERE SysTabla=:tTabla<T>, Info.Tabla)=EstatusActivo), Forma(<T>RegHist<T>))
Activo=S
ConCondicion=S
EjecucionCondicion=ConDatos(ActivoF:ActivoF.ID)
Antes=S
...
Pegado=N
Efectos=[Negritas]
[Local.ActivoF.Estado]
Carpeta=Local
Clave=ActivoF.Estado
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Local.ActivoF.AreaM2]
Carpeta=Local
Clave=ActivoF.AreaM2
Editar=S
ValidaNombre=S
3D=S
Tamano=15
...
[Acciones.svPropiedadesMtroAF]
Nombre=svPropiedadesMtroAF
Boton=0
Menu=&Maestros
NombreDesplegar=Propiedades AF
EnMenu=S
TipoAccion=Formas
ClaveAccion=svPropiedadesMtroAF
Activo=S
Visible=S
...
Pestana=S
Detalle=S
VistaMaestra=ActivoF
LlaveLocal=(Lista)
LlaveMaestra=(Lista)
[PropiedadesAF.PropiedadesAF.Propiedad]
Carpeta=PropiedadesAF
...
[PropiedadesAF.PropiedadesAF.CostoXMt2]
Carpeta=PropiedadesAF
...
[PropiedadesAF.PropiedadesAF.CostoFijo]
Carpeta=PropiedadesAF
...
[PropiedadesAF.PropiedadesAF.Articulo]
Carpeta=PropiedadesAF
...
[PropiedadesAF.Art.Descripcion1]
Carpeta=PropiedadesAF
Clave=Art.Descripcion1
LineaNueva=S
ValidaNombre=S
...
[PropiedadesAF.LlaveLocal]
(Inicio)=PropiedadesAF.LocalArt
PropiedadesAF.LocalArt=PropiedadesAF.Serie
PropiedadesAF.Serie=(Fin)

[PropiedadesAF.LlaveMaestra]
(Inicio)=ActivoF.Articulo
ActivoF.Articulo=ActivoF.Serie
ActivoF.Serie=(Fin)

[PropiedadesAF.ListaEnCaptura]
(Inicio)=PropiedadesAF.Propiedad
...
PropiedadesAF.Articulo=Art.Descripcion1
...
[Contable.ActivoF.CuentaSV]
Carpeta=Contable
Clave=ActivoF.CuentaSV
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Local.ActivoF.AreaM2D]
Carpeta=Local
Clave=ActivoF.AreaM2D
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
(Inicio)=ActivoF.Articulo
ActivoF.Articulo=ActivoF.Serie
ActivoF.Serie=ActivoF.Estado
ActivoF.Estado=ActivoF.AreaM2
ActivoF.AreaM2=ActivoF.AreaM2D
ActivoF.AreaM2D=(Fin)
...
ActivoF.ValorDesecho=ActivoF.CuentaSV
ActivoF.CuentaSV=(Fin)
...
Otros8=Otros9
Otros9=Otros7
Otros7=svPropiedadesMtroAF
svPropiedadesMtroAF=(Fin)
