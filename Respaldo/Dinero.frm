...
FichaColorFondo=Plata
FichaAlineacionDerecha=S
Totalizadores1=Importe Total<BR>Total Efectivo
Totalizadores2=Caso  fnSubMovTipo( <T>DIN<T>, Dinero:Dinero.Mov )     Es <T>DIN.AMULTIMONEDA<T> Entonces (Suma(DineroD:ImporteTipoCambioD)) Es ,<T>DIN.CMULTIMONEDA<T> Entonces (Suma(DineroD:ImporteTipoCambioD))    ES ,<T>DIN.CPMULTIMONEDA<T> Entonces (Suma(DineroD:ImporteTipoCambioD)) Sino  Suma( DineroD:DineroD.Importe ) Fin<BR>suma(DesgloseEfectivo:DesgloseEfectivo.Total)
...
VisibleCondicion=Dinero:Dinero.Mov<><T>CORTE CAJA<T>
...
[DesgloseEfectivo.DesgloseEfectivo.Efectivo]
Carpeta=DesgloseEfectivo
...
[DesgloseEfectivo.DesgloseEfectivo.Cantidad]
Carpeta=DesgloseEfectivo
...
[DesgloseEfectivo.DesgloseEfectivo.Total]
Carpeta=DesgloseEfectivo
...
[Acciones.ActualizarD]
Nombre=ActualizarD
Boton=99
NombreDesplegar=Actualizar Desgloce
EnBarraHerramientas=S
ConfirmarAntes=S
...
GuardarAntes=S
Expresion=EJECUTARSQL(<T>EXEC spCargarEfectivo :n1<T>,Dinero:Dinero.ID)<BR>ACTUALIZARFORMA
ActivoCondicion=(Dinero:Dinero.Mov =<T>Apertura Caja<T>)   o  (Dinero:Dinero.Mov =<T>Corte Caja<T>)
...
[DesgloseEfectivo.ListaEnCaptura]
(Inicio)=DesgloseEfectivo.Efectivo
...
[(Carpeta Totalizadores).Total Efectivo]
Carpeta=(Carpeta Totalizadores)
Clave=Total Efectivo
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
(Inicio)=Total Efectivo
Total Efectivo=Importe Total
Importe Total=(Fin)
...
Nombre=FormaPago
Boton=38
NombreDesplegar=FormaPa
EnBarraHerramientas=S
EnMenu=S
TipoAccion=Formas
ClaveAccion=ValidarFormaPago
Visible=S
...
ActivoCondicion=(Dinero:Dinero.Mov=<T>CORTE CAJA<T>) Y (Dinero:Dinero.Estatus=<T>SINAFECTAR<T>)
AntesExpresiones=ASIGNA(Info.Numero,Dinero:Dinero.ID)
[Acciones.ActualizarRef]
Nombre=ActualizarRef
Boton=22
NombreDesplegar=Actualizar RF
EnBarraHerramientas=S
TipoAccion=Expresion
Activo=S
Visible=S
...
GuardarAntes=S
Expresion=EJECUTARSQL(<T>EXEC spActualizarReferenciaFM :n1<T>,Dinero:Dinero.ID)<BR>ACTUALIZARFORMA
...
MovPos=Navegador
Navegador=ActualizarD
ActualizarD=ActualizarRef
ActualizarRef=FormaPago
FormaPago=Cerrar
Cerrar=Otros1
Otros1=Otros2
Otros2=Otros3
