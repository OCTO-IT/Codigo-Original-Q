...
EjecucionCondicion=ConDatos(Contrato:Contrato.Mov) y SQL(<T>SELECT COUNT(*) FROM ContratoDSV WHERE ID=:n1<T>,Contrato:Contrato.ID)>0
EjecucionMensaje=<T>No hay cobros en el detalle.<T>
EjecucionConError=S
...
[Ficha.Contrato.FechaFacturacion]
Carpeta=Ficha
Clave=Contrato.FechaFacturacion
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
Tamano=22
[Ficha.Contrato.DocGenerar]
Carpeta=Ficha
Clave=Contrato.DocGenerar
Editar=S
ValidaNombre=S
3D=S
Tamano=20
...
Vista=ContratoDSV
Fuente={Tahoma, 8, Negro, []}
VistaMaestra=Contrato
LlaveLocal=ContratoDSV.ID
...
[ContratoDSV.ContratoDSV.Articulo]
Carpeta=ContratoDSV
...
[ContratoDSV.ContratoDSV.Precio]
Carpeta=ContratoDSV
...
[Ficha.Contrato.PeriodosContrato]
Carpeta=Ficha
Clave=Contrato.PeriodosContrato
ValidaNombre=S
3D=S
ColorFondo=Blanco
...
Expresion=asigna(Info.ID,Contrato:Contrato.ID)
[Acciones.Retiro]
Nombre=Retiro
Boton=40
NombreEnBoton=S
NombreDesplegar=Retiro de Contrato
Multiple=S
EnBarraHerramientas=S
ConfirmarAntes=S
...
ActivoCondicion=Contrato:Contrato.Estatus=<T>VIGENTE<T>
[Acciones.Retiro.RetiroContrato]
Nombre=RetiroContrato
Boton=0
TipoAccion=Formas
ClaveAccion=RetiroContrato
Activo=S
Visible=S
...
[Acciones.Retiro.CancelarContrato]
Nombre=CancelarContrato
Boton=0
TipoAccion=Expresion
Activo=S
Visible=S
...
Expresion=Cancelar(<T>PACTO<T>, Contrato:Contrato.ID, Afectar.Mov, Afectar.MovID, <T>Todo<T>, <T><T>, <T>PACTO<T>)
[Acciones.Retiro.Actualizar Forma]
...
MostrarConteoRegistros=S
Zona=A1
Vista=FiadorContrato
Fuente={Tahoma, 8, Negro, []}
VistaMaestra=Contrato
LlaveLocal=FiadorContrato.ID
LlaveMaestra=Contrato.ID
FichaEspacioEntreLineas=6
FichaEspacioNombres=100
FichaEspacioNombresAuto=S
...
[FiadorContrato.FiadorContrato.Cliente]
Carpeta=FiadorContrato
...
[Acciones.Retiro.GeneracionPenalidad]
Nombre=GeneracionPenalidad
Boton=0
TipoAccion=Expresion
Activo=S
Visible=S

Expresion=informacion(SQL(<T>spGenerarPenalidadContrato :n1, :t2<T>,Contrato:Contrato.ID,Usuario))

[Acciones.GenerarLetras.Guardar Cambios]
...
[Acciones.GenerarLetras.SQL]
Nombre=SQL
Boton=0
TipoAccion=Expresion
Expresion=EjecutarSQL(<T>spGenerarLetras :n1<T>,Contrato:Contrato.ID)
Activo=S
Visible=S

[Acciones.GenerarLetras.CuotasContrato]
Nombre=CuotasContrato
Boton=0
TipoAccion=Formas
ClaveAccion=CuotasContrato
Activo=S
Visible=S

[Acciones.GenerarLetras]
Nombre=GenerarLetras
Boton=50
NombreEnBoton=S
NombreDesplegar=Generar Letras
Multiple=S
EnBarraHerramientas=S
ListaAccionesMultiples=(Lista)
...
ActivoCondicion=Contrato:Contrato.Estatus<><T>CANCELADO<T>
VisibleCondicion=Contrato:Contrato.Estatus<><T>CANCELADO<T>
[Acciones.VerLetras]
Nombre=VerLetras
Boton=17
NombreEnBoton=S
NombreDesplegar=Ver Letras
EnBarraHerramientas=S
TipoAccion=Expresion
Activo=S
Visible=S
...
[Acciones.VerLetras.CuotasContrato]
Nombre=CuotasContrato
Boton=0
TipoAccion=Formas
ClaveAccion=CuotasContrato
...
[Acciones.GenerarLetras.Expresion]
Nombre=Expresion
Boton=0
TipoAccion=Expresion
Expresion=asigna(Info.ID,Contrato:Contrato.ID)
...
[Acciones.ContratoDef]
Nombre=ContratoDef
Boton=9
NombreEnBoton=S
NombreDesplegar=Tabla Anual
EnBarraHerramientas=S
EspacioPrevio=S
TipoAccion=Formas
ClaveAccion=ContratoDef
Antes=S
...
VisibleCondicion=Contrato:Contrato.Estatus<><T>CANCELADO<T>
[Acciones.Retiro.ListaAccionesMultiples]
(Inicio)=Expresion
Expresion=RetiroContrato
RetiroContrato=GeneracionPenalidad
GeneracionPenalidad=CancelarContrato
CancelarContrato=Actualizar Forma
...
[Acciones.svTipoLocal]
Nombre=svTipoLocal
Boton=0
Menu=&Maestros
NombreDesplegar=Tipos de Local
EnMenu=S
TipoAccion=Formas
ClaveAccion=svTipoLocal
Activo=S
Visible=S
...
[Acciones.svPropiedadesMtro]
Nombre=svPropiedadesMtro
Boton=0
NombreDesplegar=Propiedades
TipoAccion=Formas
ClaveAccion=svPropiedadesMtro
...
[FiadorContrato.ListaEnCaptura]
(Inicio)=FiadorContrato.Cliente
...
[ContratoDSV.ListaEnCaptura]
(Inicio)=ContratoDSV.Articulo
ContratoDSV.Articulo=Art.Descripcion1
Art.Descripcion1=ContratoDSV.Precio
ContratoDSV.Precio=(Fin)
...
Pestana=S
PestanaOtroNombre=S
PestanaNombre=Propiedades Local
...
MostrarConteoRegistros=S
Zona=A1
Vista=ContratoPropiedades
Fuente={Tahoma, 8, Negro, []}
VistaMaestra=Contrato
LlaveLocal=ContratoPropiedades.IDContrato
LlaveMaestra=Contrato.ID
HojaTitulos=S
HojaMostrarColumnas=S
HojaMostrarRenglones=S
...
[ContratoPropiedades.ContratoPropiedades.Propiedad]
Carpeta=ContratoPropiedades
...
[ContratoPropiedades.ContratoPropiedades.CostoXMt2]
Carpeta=ContratoPropiedades
...
[ContratoPropiedades.ContratoPropiedades.CostoFijo]
Carpeta=ContratoPropiedades
...
[ContratoPropiedades.ContratoPropiedades.Articulo]
Carpeta=ContratoPropiedades
...
[ContratoPropiedades.Art.Descripcion1]
Carpeta=ContratoPropiedades
Clave=Art.Descripcion1
LineaNueva=S
ValidaNombre=S
...
Boton=64
NombreEnBoton=S
NombreDesplegar=Cargar Servicios
GuardarAntes=S
TipoAccion=Expresion
...
Expresion=informacion(SQL(<T>spContCargarPropiedades :n1<T>,Contrato:Contrato.ID))
[Acciones.CargaProp]
Nombre=CargaProp
Boton=52
NombreEnBoton=S
NombreDesplegar=Cargar Propiedades
EnBarraHerramientas=S
TipoAccion=Expresion
...
GuardarAntes=S
Expresion=informacion(SQL(<T>spContCargarPropiedadesAF :n1<T>,Contrato:Contrato.ID))<BR>ActualizarForma
ActivoCondicion=Contrato:Contrato.Estatus<><T>CANCELADO<T>
VisibleCondicion=Contrato:Contrato.Estatus<><T>CANCELADO<T>

[ContratoPropiedades.ListaEnCaptura]
(Inicio)=ContratoPropiedades.Propiedad
...
ContratoPropiedades.Articulo=Art.Descripcion1
...
AntesExpresiones=ASIGNA(Info.ID,Contrato:Contrato.ID)<BR>ASIGNA(Info.Modulo,<T>PACTO<T>)
[Acciones.GenerarLetras.ListaAccionesMultiples]
(Inicio)=Guardar Cambios
Guardar Cambios=SQL
SQL=Expresion
Expresion=CuotasContrato
CuotasContrato=(Fin)




[Acciones.VerLetras.ListaAccionesMultiples]
(Inicio)=Expresion
Expresion=CuotasContrato
CuotasContrato=(Fin)
...
Contrato.Desde=Contrato.Hasta
Contrato.Hasta=Contrato.PeriodosContrato
Contrato.PeriodosContrato=Contrato.Contrato
Contrato.Contrato=Contrato.Titulo
Contrato.Titulo=Contrato.FechaFacturacion
Contrato.FechaFacturacion=Contrato.DocGenerar
Contrato.DocGenerar=Contrato.Articulo
...
Documento=ContratoDSV
ContratoDSV=FiadorContrato
FiadorContrato=ContratoPropiedades
ContratoPropiedades=(Fin)
...
Otros7=Otros8
Otros8=Otros9
Otros9=GenerarLetras
GenerarLetras=VerLetras
VerLetras=Retiro
Retiro=ContratoDef
ContratoDef=svTipoLocal
svTipoLocal=svPropiedadesMtro
svPropiedadesMtro=Expresion
Expresion=CargaProp
CargaProp=SituacionHistorico
