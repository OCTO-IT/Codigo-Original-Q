...
Boton=0
Menu=&Edición
NombreDesplegar=&2: Propiedades de la Nómina
EnMenu=S
TipoAccion=Formas
...
Pestana=S
PestanaOtroNombre=S
PestanaNombre=Configuración Web
Clave=Web
PermiteEditar=S
AlineacionAutomatica=S
AcomodarTexto=S
...
Boton=0
Menu=&Edición
NombreDesplegar=&4: Sucursales Bancarias Válidas
EnMenu=S
TipoAccion=Formas
...
ConCondicion=S
Visible=S
Expresion=EditarDocumentacion(<T>SUC<T>, Sucursal:Sucursal.Sucursal, <T>Documentación - <T>+ Sucursal:Sucursal.Nombre)
EjecucionCondicion=ConDatos(Sucursal:Sucursal.Sucursal)
