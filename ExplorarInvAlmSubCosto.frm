...
Zona=A1
Vista=ArtSubExistenciaReservadoCosto
...
IconosNombre=ArtSubExistenciaReservadoCosto:Art.Articulo
...
NombreEnBoton=S
ConCondicion=S
EjecucionCondicion=ConDatos(ArtSubExistenciaReservadoCosto:Art.Articulo)
AntesExpresiones=Asigna( Info.Articulo, ArtSubExistenciaReservadoCosto:Art.Articulo)
