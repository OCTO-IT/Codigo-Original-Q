...
SerieLoteMov.Propiedades=SerieLoteMov.Largo
SerieLoteMov.Largo=SerieLoteMov.Ancho
SerieLoteMov.Ancho=SerieLoteMov.Mts2
SerieLoteMov.Mts2=SerieLoteMov.UbicacionGeografica
SerieLoteMov.UbicacionGeografica=(Fin)

[Lista.SerieLoteMov.Largo]
Carpeta=Lista
Clave=SerieLoteMov.Largo
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Lista.SerieLoteMov.Ancho]
Carpeta=Lista
Clave=SerieLoteMov.Ancho
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Lista.SerieLoteMov.Mts2]
Carpeta=Lista
Clave=SerieLoteMov.Mts2
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Lista.SerieLoteMov.UbicacionGeografica]
Carpeta=Lista
Clave=SerieLoteMov.UbicacionGeografica
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
