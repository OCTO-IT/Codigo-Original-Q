...
AntesExpresiones=Asigna(Temp.Texto, SQL(<T>spPlantillaProyectoDVerificar :tPlantilla<T>, Info.Plantilla))<BR>Si(ConDatos(Temp.Texto), Error(Temp.Texto) AbortarOperacion)
...
EspacioPrevio=S
ConCondicion=S
EjecucionCondicion=ConDatos(PlantillaProyectoD:PlantillaProyectoD.Actividad)
AntesExpresiones=Asigna(Info.Actividad, PlantillaProyectoD:PlantillaProyectoD.Actividad)
