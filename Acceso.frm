...
AntesExpresiones=Asigna(Acceso:Acceso.Contrasena, MD5(Acceso:Acceso.Contrasena, <T>p<T>))
[Acciones.Cancelar]
Nombre=Cancelar
Boton=0
...
EjecucionMensaje=Inc(Temp.Num)<BR>Si(Temp.Num>5, EjecutarSQL(<T>spBloquearUsuario :tUsuario<T>, Acceso:Acceso.Usuario) <T>Invalid Password, User Blocked<T>, <T>Invalid Password<T>)
