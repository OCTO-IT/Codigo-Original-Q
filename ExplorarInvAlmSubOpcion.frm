...
Zona=A1
Vista=ArtSubExistenciaReservadoOpcion
...
IconosNombre=ArtSubExistenciaReservadoOpcion:Art.Articulo
...
EjecucionCondicion=ConDatos(ArtSubExistenciaReservadoOpcion:Art.Articulo)
AntesExpresiones=Asigna( Info.Articulo, ArtSubExistenciaReservadoOpcion:Art.Articulo)
...
[Lista.ListaOrden]
(Inicio)=ArtSubExistenciaReservadoOpcion.Articulo	(Decendente)
ArtSubExistenciaReservadoOpcion.Articulo	(Decendente)=ArtSubExistenciaReservadoOpcion.SubCuenta	(Acendente)
