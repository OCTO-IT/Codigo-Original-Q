...
FiltroGeneral=Presupuesto.Empresa=<T>{Empresa}<T> AND <BR>Presupuesto.Cuenta=<T>{Art:Art.CuentaPresupuesto}<T>
...
FiltroGeneral=ArtDisponibleTarima.Articulo = <T>{Info.Articulo}<T><BR>AND ArtDisponibleTarima.Disponible <>0
...
ArtDisponibleTarima.Disponible=Tarima.Almacen
