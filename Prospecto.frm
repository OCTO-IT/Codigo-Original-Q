...
EjecucionCondicion=ConDatos(Prospecto:Prospecto.Prospecto)
AntesExpresiones=Asigna(Info.Prospecto, Prospecto:Prospecto.Prospecto)<BR>Asigna(Info.Nombre, Prospecto:Prospecto.Nombre)<BR>Asigna(Info.Dato, SQL(<T>SELECT CRMID FROM Prospecto WHERE Prospecto=:tProspecto<T>,Info.Prospecto))
...
EjecucionCondicion=ConDatos(Prospecto:Prospecto.Prospecto)
Antes=S
AntesExpresiones=Asigna(Info.Nombre, Prospecto:Prospecto.Prospecto & <T> <T> & Prospecto:Prospecto.Nombre)
...
[Acciones.InteresadoEn]
Nombre=InteresadoEn
Boton=0
Menu=&Maestros
NombreDesplegar=&Interesado en
EnMenu=S
TipoAccion=Formas
ClaveAccion=ProspectoInteresadoEn
Activo=S
Visible=S
...
[Acciones.ProspectoTarea]
Nombre=ProspectoTarea
Boton=0
Menu=&Maestros
NombreDesplegar=&Tareas a Prospectos
EnMenu=S
TipoAccion=Formas
ClaveAccion=ProspectoTarea
Activo=S
Visible=S
...
[Ficha.Prospecto.GrupoEmpresarial]
Carpeta=Ficha
Clave=Prospecto.GrupoEmpresarial
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
[Ficha.Prospecto.EmpresaTipo]
Carpeta=Ficha
Clave=Prospecto.EmpresaTipo
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Ficha.Prospecto.Fuente]
Carpeta=Ficha
Clave=Prospecto.Fuente
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
[Referencia.Prospecto.ReferidoMail]
Carpeta=Referencia
Clave=Prospecto.ReferidoMail
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Referencia.Prospecto.ReferidoTelefono]
Carpeta=Referencia
Clave=Prospecto.ReferidoTelefono
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Referencia.Prospecto.ReferidoRFC]
Carpeta=Referencia
Clave=Prospecto.ReferidoRFC
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Ficha.Prospecto.NombreComercial]
Carpeta=Ficha
Clave=Prospecto.NombreComercial
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Referencia.Prospecto.ReferidoNombre]
Carpeta=Referencia
Clave=Prospecto.ReferidoNombre
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
Boton=0
Menu=&Maestros
NombreDesplegar=Tipos de Fuente
EnBarraHerramientas=S
EnMenu=S
TipoAccion=Formas
ClaveAccion=TipoFuente
Activo=S
Visible=S
...
[Acciones.TipoEmpresa]
Nombre=TipoEmpresa
Boton=0
Menu=&Maestros
EsDefault=S
NombreDesplegar=Tipos de Empresa
EnBarraHerramientas=S
EnMenu=S
TipoAccion=Formas
ClaveAccion=TipoEmpresa
Activo=S
Visible=S
...
Clave=ProspectoIntelisis
PermiteEditar=S
AlineacionAutomatica=S
AcomodarTexto=S
MostrarConteoRegistros=S
Zona=A1
Vista=ProspectoIntelisis
Fuente={Tahoma, 8, Negro, []}
FichaEspacioEntreLineas=6
FichaEspacioNombres=100
FichaEspacioNombresAuto=S
...
Detalle=S
VistaMaestra=Prospecto
LlaveLocal=ProspectoIntelisis.Prospecto
LlaveMaestra=Prospecto.Prospecto
CondicionVisible=condatos(Prospecto:Prospecto.Prospecto)
[ProspectoIntelisis.ProspectoIntelisis.SistemaActual]
Carpeta=ProspectoIntelisis
Clave=ProspectoIntelisis.SistemaActual
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[ProspectoIntelisis.ProspectoIntelisis.NumeroUsuarios]
Carpeta=ProspectoIntelisis
Clave=ProspectoIntelisis.NumeroUsuarios
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
Tamano=30
Pegado=N
[ProspectoIntelisis.ProspectoIntelisis.Problema]
Carpeta=ProspectoIntelisis
Clave=ProspectoIntelisis.Problema
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[ProspectoIntelisis.ProspectoIntelisis.eMailSistemas]
Carpeta=ProspectoIntelisis
Clave=ProspectoIntelisis.eMailSistemas
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
EspacioPrevio=N
[ProspectoIntelisis.ProspectoIntelisis.emailFinanzas]
Carpeta=ProspectoIntelisis
Clave=ProspectoIntelisis.emailFinanzas
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
[ProspectoIntelisis.ProspectoIntelisis.CoordinaEvaluacion]
Carpeta=ProspectoIntelisis
Clave=ProspectoIntelisis.CoordinaEvaluacion
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[ProspectoIntelisis.ProspectoIntelisis.SistemaExperto]
Carpeta=ProspectoIntelisis
Clave=ProspectoIntelisis.SistemaExperto
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
MostrarConteoRegistros=S
Zona=A1
Vista=ProspectoInteresadoEnD
Fuente={Tahoma, 8, Negro, []}
VistaMaestra=Prospecto
LlaveLocal=ProspectoInteresadoEnD.Prospecto
LlaveMaestra=Prospecto.Prospecto
...
PermiteEditar=S
CondicionVisible=condatos(Prospecto:Prospecto.Prospecto)
[InteresadoEnD.ProspectoInteresadoEnD.InteresadoEn]
Carpeta=InteresadoEnD
Clave=ProspectoInteresadoEnD.InteresadoEn
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Acciones.TipoLicenciamiento]
Nombre=TipoLicenciamiento
Boton=0
Menu=&Maestros
EsDefault=S
NombreDesplegar=Tipos de Licenciamiento
EnBarraHerramientas=S
EnMenu=S
TipoAccion=Formas
ClaveAccion=TipoLicenciamiento
Activo=S
Visible=S
...
[Acciones.TipoRelacionReferencia]
Nombre=TipoRelacionReferencia
Boton=0
Menu=&Maestros
EsDefault=S
NombreDesplegar=Tipos de Relacion de Referencia
EnBarraHerramientas=S
EnMenu=S
TipoAccion=Formas
ClaveAccion=TipoRelacionReferencia
Activo=S
Visible=S
...
[Acciones.TipoCoordinaciónEvaluacio]
Nombre=TipoCoordinaciónEvaluacio
Boton=0
Menu=&Maestros
EsDefault=S
NombreDesplegar=Tipos de Coordinación de Evaluación
EnBarraHerramientas=S
EnMenu=S
TipoAccion=Formas
ClaveAccion=TipoCoordinacionEvaluacion
Activo=S
Visible=S
...
[Acciones.TipoSistemaExperto]
Nombre=TipoSistemaExperto
Boton=0
Menu=&Maestros
EsDefault=S
NombreDesplegar=Tipos de Sistema Experto
EnBarraHerramientas=S
EnMenu=S
TipoAccion=Formas
ClaveAccion=TipoSistemaExperto
Activo=S
Visible=S
...
[Acciones.TipoSistemaActual]
Nombre=TipoSistemaActual
Boton=0
Menu=&Maestros
EsDefault=S
NombreDesplegar=Tipos de Sistema Actual
EnBarraHerramientas=S
EnMenu=S
TipoAccion=Formas
ClaveAccion=TipoSistemaActual
Activo=S
Visible=S
...
[ProspectoIntelisis.ProspectoIntelisis.NombreSistemas]
Carpeta=ProspectoIntelisis
Clave=ProspectoIntelisis.NombreSistemas
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
EspacioPrevio=S
[ProspectoIntelisis.ProspectoIntelisis.NombreFinanzas]
Carpeta=ProspectoIntelisis
Clave=ProspectoIntelisis.NombreFinanzas
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[ProspectoIntelisis.ProspectoIntelisis.MontoEstimado]
Carpeta=ProspectoIntelisis
Clave=ProspectoIntelisis.MontoEstimado
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[ProspectoIntelisis.ProspectoIntelisis.TipoLicenciamiento]
Carpeta=ProspectoIntelisis
Clave=ProspectoIntelisis.TipoLicenciamiento
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[TipoSistemaActualLista.Columnas]
Descripcion=258

[TipoCoordinacionEvaluacionLista.Columnas]
Descripcion=299
...
[ProspectoIntelisis.ListaEnCaptura]
(Inicio)=ProspectoIntelisis.SistemaActual
ProspectoIntelisis.SistemaActual=ProspectoIntelisis.NumeroUsuarios
ProspectoIntelisis.NumeroUsuarios=ProspectoIntelisis.Problema
ProspectoIntelisis.Problema=ProspectoIntelisis.TipoLicenciamiento
ProspectoIntelisis.TipoLicenciamiento=ProspectoIntelisis.SistemaExperto
ProspectoIntelisis.SistemaExperto=ProspectoIntelisis.NombreSistemas
ProspectoIntelisis.NombreSistemas=ProspectoIntelisis.eMailSistemas
ProspectoIntelisis.eMailSistemas=ProspectoIntelisis.NombreFinanzas
ProspectoIntelisis.NombreFinanzas=ProspectoIntelisis.emailFinanzas
ProspectoIntelisis.emailFinanzas=ProspectoIntelisis.CoordinaEvaluacion
ProspectoIntelisis.CoordinaEvaluacion=ProspectoIntelisis.MontoEstimado
ProspectoIntelisis.MontoEstimado=(Fin)




[Referencia.ListaEnCaptura]
(Inicio)=Prospecto.ReferidoNombre
Prospecto.ReferidoNombre=Prospecto.ReferidoMail
Prospecto.ReferidoMail=Prospecto.ReferidoTelefono
Prospecto.ReferidoTelefono=Prospecto.ReferidoRFC
Prospecto.ReferidoRFC=Prospecto.RelacionReferencia
Prospecto.RelacionReferencia=(Fin)

[Referencia.Prospecto.RelacionReferencia]
Carpeta=Referencia
Clave=Prospecto.RelacionReferencia
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[TipoRelacionReferenciaLista.Columnas]
Descripcion=279
...
Pestana=S
PestanaOtroNombre=S
PestanaNombre=Productos A Evaluar
Clave=ProductosAEvaluar
Detalle=S
AlineacionAutomatica=S
AcomodarTexto=S
MostrarConteoRegistros=S
...
Vista=ProspectoCompetenciaD
VistaMaestra=Prospecto
LlaveLocal=ProspectoCompetenciaD.Prospecto
LlaveMaestra=Prospecto.Prospecto
ListaEnCaptura=(Lista)
...
Competencia=64
[Acciones.ProductosAEvaluar]
Nombre=ProductosAEvaluar
Boton=0
Menu=&Maestros
EsDefault=S
NombreDesplegar=Productos A Evaluar
GuardarAntes=S
EnBarraHerramientas=S
EnMenu=S
TipoAccion=Formas
ClaveAccion=ProspectoCompetencia
Activo=S
Visible=S
...
[ProductosAEvaluar.ProspectoCompetencia.Descripcion]
Carpeta=ProductosAEvaluar
...
Tamano=40
ColorFondo=Blanco
ColorFuente=$008F8F8F





[ProductosAEvaluar.ProspectoCompetenciaD.Competencia]
Carpeta=ProductosAEvaluar
...
[ProductosAEvaluar.ListaEnCaptura]
(Inicio)=ProspectoCompetenciaD.Competencia
...
[InteresadoEnD.ProspectoInteresadoEn.Articulo]
Carpeta=InteresadoEnD
...
[InteresadoEnD.ListaEnCaptura]
(Inicio)=ProspectoInteresadoEnD.InteresadoEn
ProspectoInteresadoEnD.InteresadoEn=ProspectoInteresadoEn.Articulo
ProspectoInteresadoEn.Articulo=(Fin)
...
[Acciones.TipoProspecto]
Nombre=TipoProspecto
Boton=0
Menu=&Maestros
NombreDesplegar=Tipos de Prospecto
EnBarraHerramientas=S
EnMenu=S
TipoAccion=Formas
ClaveAccion=ProspectoTipo
Activo=S
Visible=S
...
[Acciones.ContactosCRM]
Nombre=ContactosCRM
Boton=0
Menu=&Edición
EsDefault=S
NombreDesplegar=Contactos Dynamics CRM
EnMenu=S
TipoAccion=Expresion
Activo=S

EspacioPrevio=S
Expresion=Asigna(CteX.Direccion, SQL(<T>SELECT UrlCRM FROM EmpresaGral WHERE Empresa = :tEmpresa<T>,  Empresa ))<BR>Asigna(Info.Descripcion,CteX.Direccion + <T>/_root/homepage.aspx?etc=2#<T>)<BR>Browser(Info.Descripcion ,<T>Informacion de CRM<T>)
VisibleCondicion=Prospecto:Prospecto.SincronizarCRM
[Acciones.ClientesPotencialesCRM]
Nombre=ClientesPotencialesCRM
Boton=0
Menu=&Edición
EsDefault=S
NombreDesplegar=Clientes Potenciales Dynamics CRM
EnMenu=S
TipoAccion=Expresion
Activo=S
...
Expresion=Asigna(CteX.Direccion, SQL(<T>SELECT UrlCRM FROM EmpresaGral WHERE Empresa = :tEmpresa<T>,  Empresa ))<BR>Asigna(Info.Descripcion,CteX.Direccion + <T>/_root/homepage.aspx?etc=4#<T>)<BR>Browser(Info.Descripcion ,<T>Informacion de CRM<T>)
VisibleCondicion=Prospecto:Prospecto.SincronizarCRM
[Ficha.Prospecto.ApellidoPaterno]
Carpeta=Ficha
Clave=Prospecto.ApellidoPaterno
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Ficha.Prospecto.ApellidoMaterno]
Carpeta=Ficha
Clave=Prospecto.ApellidoMaterno
Editar=S
ValidaNombre=S
3D=S
Tamano=23
...
[Ficha.Prospecto.SincronizarCRM]
Carpeta=Ficha
Clave=Prospecto.SincronizarCRM
Editar=S
ValidaNombre=N
3D=S
ColorFondo=Blanco
...
Prospecto.SIC=Prospecto.ApellidoPaterno
Prospecto.ApellidoPaterno=Prospecto.ApellidoMaterno
Prospecto.ApellidoMaterno=Prospecto.NombreComercial
Prospecto.NombreComercial=Prospecto.GrupoEmpresarial
Prospecto.GrupoEmpresarial=Prospecto.Categoria
Prospecto.Categoria=Prospecto.Grupo
Prospecto.Grupo=Prospecto.Familia
Prospecto.Familia=Prospecto.EmpresaTipo
Prospecto.EmpresaTipo=Prospecto.Origen
Prospecto.Origen=Prospecto.Fuente
Prospecto.Fuente=Prospecto.RFC
Prospecto.RFC=Prospecto.CURP
...
Prospecto.EntreCalles=Prospecto.Observaciones
Prospecto.Observaciones=Prospecto.Plano
Prospecto.Plano=Prospecto.Delegacion
...
Prospecto.PedirTono=Prospecto.eMail
Prospecto.eMail=Prospecto.PaginaWeb
Prospecto.PaginaWeb=Prospecto.Agente
Prospecto.Agente=Agente.Nombre
Agente.Nombre=Prospecto.SincronizarCRM
Prospecto.SincronizarCRM=(Fin)
...
FormaExtraValor=Referencia
Referencia=ProspectoIntelisis
ProspectoIntelisis=InteresadoEnD
InteresadoEnD=ProductosAEvaluar
ProductosAEvaluar=(Fin)
...
SIC=Origen
Origen=InteresadoEn
InteresadoEn=ProspectoTarea
ProspectoTarea=ProductosAEvaluar
ProductosAEvaluar=TipoFuente
TipoFuente=TipoEmpresa
TipoEmpresa=TipoLicenciamiento
TipoLicenciamiento=TipoRelacionReferencia
TipoRelacionReferencia=TipoCoordinaciónEvaluacio
TipoCoordinaciónEvaluacio=TipoSistemaExperto
TipoSistemaExperto=TipoSistemaActual
TipoSistemaActual=TipoProspecto
TipoProspecto=ContactosCRM
ContactosCRM=ClientesPotencialesCRM
ClientesPotencialesCRM=(Fin)
