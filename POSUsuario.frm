...
ExpresionesAlMostrar=Asigna(Info.Visible,falso)
MenuPrincipal=(Lista)
...
ExpAntesRefrescar=Asigna(Info.Visible,Falso)<BR>Asigna(Info.Bloqueado,Falso)   <BR>Forma.ActualizarControles
...
FiltroTipo=General
RefrescarAlEntrar=S
ExpAntesRefrescar=Asigna(Info.Visible,Falso)<BR>Asigna(Info.Bloqueado,verdadero)   <BR>Forma.ActualizarControles<BR>Asigna(Info.Usuario,POSUsuario:POSUsuario.Usuario)<BR>SI(ConDatos(POSUsuario:POSUsuario.POSPerfil),Asigna(Info.Usuario,POSUsuario:POSUsuario.POSPerfil))
FiltroGeneral=POSUsuarioAccion.Usuario = <T>{Info.Usuario}<T>
CondicionEdicion=Vacio(POSUsuario:POSUsuario.POSPerfil)
...
RefrescarAlEntrar=S
ExpAntesRefrescar=Asigna(Info.Visible,verdadero)<BR>Asigna(Info.Bloqueado,Falso)   <BR>Forma.ActualizarControles<BR>Asigna(Info.Usuario,POSUsuario:POSUsuario.Usuario)<BR>SI(ConDatos(POSUsuario:POSUsuario.POSPerfil),Asigna(Info.Usuario,POSUsuario:POSUsuario.POSPerfil))
OtroOrden=S
...
Expresion=Asigna(Info.Usuario,POSUsuario:POSUsuario.Usuario)<BR>FormaModal(<T>POSUsuarioMovTemp<T>)<BR> Forma.ActualizarVista(<T>POSUsuarioMov<T>)
ActivoCondicion=(Info.Visible)y(Vacio(POSUsuario:POSUsuario.POSPerfil))    
...
Expresion=Asigna(Info.Usuario,POSUsuario:POSUsuario.Usuario)<BR>FormaModal(<T>POSUsuarioAccionTemp<T>)<BR> Forma.ActualizarVista(<T>POSUsuarioAccion<T>)
ActivoCondicion=(Info.Bloqueado)y(Vacio(POSUsuario:POSUsuario.POSPerfil))
...
EspacioPrevio=S
ActivoCondicion=Vacio(POSUsuario:POSUsuario.POSPerfil)
...
[Default.POSUsuario.POSEsSupervisor]
Carpeta=Default
Clave=POSUsuario.POSEsSupervisor
Editar=S
LineaNueva=S
ValidaNombre=N
3D=S
...
POSUsuario.POSPerfil=POSUsuario.POSEsSupervisor
POSUsuario.POSEsSupervisor=(Fin)
