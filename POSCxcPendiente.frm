...
ConCondicion=S
Expresion=EjecutarSQL(<T>spPOSInsertarReferenciaCobro :tEmpresa, :nSucursal, :tUsuario, :nEstacion, :nID, :tIDPOS<T>,Empresa, Sucursal, Usuario, EstacionTrabajo,POSCxcAnticipoTemp:POSCxcAnticipoTemp.ID, Info.IDTexto)<BR>Asigna(Info.Codigo,NULO)
