...
Expresion=Asigna(Temp.Reg5,SQL(<T>spPOSFacturarNotasLote :nEstacion,:tEmpresa, :nSucursal, :tUsuario, :tMov, :tCliente<T>, EstacionTrabajo, Empresa, Sucursal, Usuario, POSFacturarNotasTemp:POSFacturarNotasTemp.MovFactura, POSFacturarNotasTemp:POSFacturarNotasTemp.Cliente))<BR>Reexpresa( Temp.Reg5[2])<BR>Asigna(Info.Descripcion, Temp.Reg5[5]+<T> <T>+Temp.Reg5[6])
