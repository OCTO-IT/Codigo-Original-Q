...
AntesExpresiones=Asigna(Info.ID, Oferta:Oferta.ID)<BR>Asigna(Info.Usar, Oferta:Oferta.Usar)
...
Oferta.Concepto=Oferta.Observaciones
...
Oferta.Porcentaje=Oferta.Obsequio
Oferta.Obsequio=Oferta.CantidadObsequio
...
ActivoCondicion=(MovTipo(<T>OFER<T>, Oferta:Oferta.Mov) = OFER.OG)
Antes=S
...
Oferta.Fabricante=Oferta.Proveedor
Oferta.Proveedor=Prov.Nombre
Prov.Nombre=Oferta.Porcentaje
Oferta.Porcentaje=Oferta.GrupoTipo
Oferta.GrupoTipo=(Fin)
