...
TipoAccion=Controles Captura
ClaveAccion=Variables Asignar
ListaAccionesMultiples=Variables Asignar<BR>mis_CompraAnalisisMovDiario
Activo=S
Visible=S
EspacioPrevio=S
NombreEnBoton=S
...
Info.UEN=Info.MovClaveAfectaRComp
Info.MovClaveAfectaRComp=Info.Estatus
Info.Estatus=Info.Almacen
Info.Almacen=Info.FechaD
Info.FechaD=Info.FechaA
Info.FechaA=(Fin)

[(Variables).Info.MovClaveAfectaRComp]
Carpeta=(Variables)
Clave=Info.MovClaveAfectaRComp
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
