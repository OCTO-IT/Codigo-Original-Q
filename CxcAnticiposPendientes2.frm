...
ExpresionesAlMostrar=EjecutarSQL(<T>spInsertarCxcAnticipoAplicarTemp :tEmpresa, :tCliente, :nPedido, :nEstacion<T>,Empresa, Info.Cliente, Info.RID, EstacionTrabajo)
[Lista]
Estilo=Hoja
Clave=Lista
PermiteEditar=S
...
AntesExpresiones=EjecutarSQL(<T>spActualizarCxcAnticipoAplicar :tEmpresa, :tCliente, :nPedido, :nEstacion, :nID<T>,Empresa, Info.Cliente, Info.RID, EstacionTrabajo, Info.ID)<BR>Si Config.CxcAnticipoTipoServicio = Falso Entonces<BR>  EjecutarSQL(<T>spCxcAnticiposPendientesAceptar :tModulo, :nID<T>, Info.Modulo, Info.ID)<BR>Fin
[Acciones.Copiar]
Nombre=Copiar
Boton=0
UsaTeclaRapida=S
